...
return new class extends Migration
{
    ...
    {
        Schema::create('category_3digit_monthly_summaries', function (Blueprint $table) {
            $table->smallInteger('year')->comment('年份');
            $table->tinyInteger('month')->comment('月份');
            $table->string('category_code', 10)->comment('三碼品群代號 (FK)');
    ...
    {
        Schema::dropIfExists('category_3digit_monthly_summaries');
    }
};
